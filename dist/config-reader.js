...
export async function countCodexConfigs(cwd) {
...
function countAgentInstructionFiles(cwd) {
    const seen = new Set();
...
function countEnabledFeatureFlags(content) {
...
function getTomlTableBody(content, tableName) {
